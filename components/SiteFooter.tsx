  ...
  return (
    <footer className="bg-dtl-navy-dark text-white/75 pt-10">
      <div className="max-w-[1220px] mx-auto px-5">
        {/* Upper site brand/info bar (moved from header top bar) */}
        <div className="border-b border-white/10 pb-6 mb-8 flex flex-col lg:flex-row justify-between items-center gap-4 text-xs md:text-[13px]">
          <span className="flex items-center gap-1.5 font-bold text-white"><Award className="w-4 h-4 text-dtl-red shrink-0" /> Đại Tài Lợi – Đồng hành cùng thương hiệu của bạn</span>
          <div className="flex items-center gap-4 md:gap-5 flex-wrap justify-center lg:justify-end text-white/70">
            <span>📧 <a href="mailto:congtydaitailoi@gmail.com" className="hover:text-white transition-colors">congtydaitailoi@gmail.com</a></span>
            <span className="hidden md:inline text-white/20">|</span>
            <span>📍 716 Nguyễn Huệ, P. Mỹ Trà, Đồng Tháp</span>
            <span className="hidden md:inline text-white/20">|</span>
            <span>📞 <a href="tel:0939991551" className="hover:text-white transition-colors">Hotline: <strong className="text-white hover:text-dtl-red">0939.991.551</strong></a></span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[2.2fr_1fr_1fr_1.8fr] gap-8 lg:gap-11 pb-10 border-b border-white/10">
          ...
          <div>
            ...
            <p className="text-[13px] mt-4 leading-[1.75]">Công Ty TNHH MTV Đại Tài Lợi – Chuyên cung cấp bao bì, chai lọ thủy tinh, hộp nhựa, phụ kiện ngành yến, in ấn phẩm và gia công CNC chất lượng cao.</p>
          ...
          <div>
            ...
            <ul className="space-y-3 mb-4">
              <li className="flex items-start gap-2.5 text-[13px] leading-[1.5]">
                ...
                <span>716 Nguyễn Huệ, P. Mỹ Trà,<br/>Tỉnh Đồng Tháp</span>
              </li>
              <li className="flex items-start gap-2.5 text-[13px] leading-[1.5]">
                <Phone className="w-4 h-4 text-dtl-red shrink-0 mt-px" />
                <span>Hotline: <a href="tel:0939991551" className="text-white/80 transition-colors hover:text-white">0939.991.551</a></span>
              </li>
              <li className="flex items-start gap-2.5 text-[13px] leading-[1.5]">
                <Mail className="w-4 h-4 text-dtl-red shrink-0 mt-px" />
                <span><a href="mailto:congtydaitailoi@gmail.com" className="text-white/80 transition-colors hover:text-white">congtydaitailoi@gmail.com</a></span>
              </li>
            </ul>
