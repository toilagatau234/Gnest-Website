  ...
  return (
    <AdminSection>
      <AdminPageHeader
        ...
        description="Quản lý cấu trúc danh mục sản phẩm, trạng thái hiển thị và thứ tự xuất hiện trên website."
        action={<CategoryFormDialog categories={safeCategories} fixedType="product" />}
      />
      ...
      {safeCategories.length > 0 ? <CategoriesTable categories={safeCategories} fixedType="product" /> : null}
    </AdminSection>
  );
}
